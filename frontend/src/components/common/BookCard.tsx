...
const BookCard: React.FC<BookCardProps> = ({ book }) => {
  ...
  return (
    <div
      className="w-44 flex-shrink-0 bg-white rounded-lg border border-gray-200 transition-all duration-300 mx-3 flex flex-col hover:scale-103 focus-within:scale-103 z-0 hover:z-20 focus-within:z-20 shadow-none hover:shadow-lg focus-within:shadow-lg cursor-pointer"
      tabIndex={0}
