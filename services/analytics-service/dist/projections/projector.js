 ...
 */
function createDefaultDocument(userId, nowIso) {
    return {
        userId,
        stats: {
            totalBooks: 0,
 ...
 */
function updateStreak(doc, timestamp) {
 ...
 */
function updateMonthly(doc, timestamp, updates) {
 ...
 */
function incrementGenreCounts(doc, genres) {
 ...
 */
function applyStatusDelta(doc, status, delta = 1) {
    if (!status)
        return;
 ...
 */
export async function projectEvent(analyticsCollection, event) {
